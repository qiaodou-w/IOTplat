<template>
  <div class="control-item">
    ...
    <van-stepper v-if="!isButton" v-model="cur" :name="name" disable-input input-width="40px" min="16" button-size="40px" @change="this.debounceStepperChange"/>
    <VanSwitch v-if="isButton" v-model="cur" @change="this.debounceSwitchChange">警报</VanSwitch>
  </div>
</template>
